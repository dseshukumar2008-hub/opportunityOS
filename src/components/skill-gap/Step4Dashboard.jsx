      ...
      <div className="flex flex-col gap-6 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full items-stretch">
          ...
          <div className="bg-white rounded-[24px] border border-slate-100 p-6 shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col h-full w-full">
            ...
            <div className="flex flex-wrap gap-1.5 mb-4 flex-1 content-start overflow-y-auto max-h-[220px] pr-2 scrollbar-thin scrollbar-thumb-slate-200 scrollbar-track-transparent">
              {(currentSkills || []).map(s => (
          ...
          <div className="bg-white rounded-[24px] border border-slate-100 p-6 shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col h-full w-full border-t-4 border-t-[#6C4CF1]">
            ...
            <p className="text-[13px] text-slate-500 font-medium leading-relaxed mb-6 flex-1">{nextSkill.reason}</p>
            
            <button className="w-full py-3.5 bg-[#6C4CF1] hover:bg-indigo-700 text-white rounded-xl text-[14px] font-bold transition-colors shadow-md mt-auto shrink-0 flex justify-center items-center gap-2">
              Start Learning
            </button>
          </div>
        </div>
